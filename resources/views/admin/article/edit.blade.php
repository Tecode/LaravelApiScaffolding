        ...
        <form action="{{url('admin/article'.'/'.$filed->art_id)}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="art_tittle" value="{{$filed->art_tittle}}">
                ...
                <tr>
                    <th>关键词：</th>
                    <td>
                        <input type="text" name="art_tag" value="{{$filed->art_tag}}">
                ...
                <tr>
                    ...
                    <td>
                        <div style="width: 20%;min-height: 60px">
                            <img class="img_pictrue" src="{{$filed->art_thump}}" width="100%"/>
                        </div>
                        <input id="file_upload" value="" type="file" multiple="true">
                        <input class="file_upload" value="{{$filed->art_thump}}" name="art_thump" type="hidden" />
                    </td>
                </tr>
                <tr>
                    <th>文章描述：</th>
                    <td>
                        <textarea class="lg" name="art_description">{{$filed->art_description}}</textarea>
                    </td>
                </tr>
                <style>
                ...
                <tr>
                    ...
                    <td width="80%" height="auto">
                        <!-- 加载编辑器的容器 -->
                        <script id="container" style="height:600px;width:auto" name="art_content" type="text/plain">{!! $filed->art_content !!}</script>
                    </td>
                </tr>
                <tr>
                    <th></th>
